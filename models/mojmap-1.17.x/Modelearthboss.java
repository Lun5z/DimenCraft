...
public class Modelearthboss<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "earthboss"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(36, 0)
				.addBox(-7.0F, -5.0F, -10.0F, 14.0F, 13.0F, 14.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition body_r1 = body.addOrReplaceChild("body_r1",
				CubeListBuilder.create().texOffs(36, 27).addBox(-4.0F, -62.0F, 24.0F, 6.0F, 28.0F, 6.0F,
		...
		PartDefinition body_r2 = body
				.addOrReplaceChild("body_r2",
						CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -45.0F, 11.0F, 8.0F, 46.0F, 10.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition leftArm_r1 = leftArm.addOrReplaceChild("leftArm_r1",
				CubeListBuilder.create().texOffs(76, 27).addBox(-20.0F, -5.0F, 2.0F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leftArm_r2 = leftArm.addOrReplaceChild("leftArm_r2",
				CubeListBuilder.create().texOffs(16, 77).addBox(-23.0F, 12.0F, -13.0F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition rightArm_r1 = rightArm.addOrReplaceChild("rightArm_r1",
				CubeListBuilder.create().texOffs(72, 65).addBox(20.0F, 16.0F, -4.0F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition rightArm_r2 = rightArm.addOrReplaceChild("rightArm_r2",
				CubeListBuilder.create().texOffs(0, 77).addBox(17.0F, -5.0F, 3.0F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leftLeg_r1 = leftLeg.addOrReplaceChild("leftLeg_r1",
				CubeListBuilder.create().texOffs(0, 56)
						.addBox(5.1F, -13.0F, -40.0F, 4.0F, 17.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 56)
						.addBox(5.1F, -13.0F, -24.0F, 4.0F, 17.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(72, 44)
						.addBox(5.1F, -13.0F, -7.0F, 4.0F, 17.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rightLeg_r1 = rightLeg.addOrReplaceChild("rightLeg_r1",
				CubeListBuilder.create().texOffs(56, 57)
						.addBox(-9.1F, -13.0F, -40.0F, 4.0F, 17.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(60, 27)
						.addBox(-9.1F, -13.0F, -24.0F, 4.0F, 17.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 61)
						.addBox(-9.1F, -13.0F, -7.0F, 4.0F, 17.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.9F, 12.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
