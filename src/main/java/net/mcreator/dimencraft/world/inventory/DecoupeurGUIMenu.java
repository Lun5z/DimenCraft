...
public class DecoupeurGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DecoupeurGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(DimencraftModMenus.DECOUPEUR_GUI, id);
