...
public class FireGolemRenderer extends HumanoidMobRenderer<FireGolemEntity, HumanoidModel<FireGolemEntity>> {
	...
	public ResourceLocation getTextureLocation(FireGolemEntity entity) {
		return new ResourceLocation("dimencraft:textures/entities/iron_golem1.png");
	}
}
