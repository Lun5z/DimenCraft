...
public class Chapter1Screen extends AbstractContainerScreen<Chapter1Menu> {
	private final static HashMap<String, Object> guistate = Chapter1Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public Chapter1Screen(Chapter1Menu container, Inventory inventory, Component text) {
