...
package net.mcreator.dimencraft.entity;
...
public class FireGolemEntity extends Monster {
	...
	public FireGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DimencraftModEntities.FIRE_GOLEM.get(), world);
	}

	public FireGolemEntity(EntityType<FireGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 15;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(DimencraftModItems.FIRE_INGOT.get()));
	}
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.deepslate_bricks.step")), 0.15f, 1);
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.KNOCKBACK_RESISTANCE, 0.7000000000000001);
